...
class LoadCompleteDataApi {
  static Future<LoadComplete> getData(int docEntry) async {
    ...
    try {
      ...
      log('http://91.203.133.224:92/api/WareSmart/v1/PostAuditLoadComplete?AuditId=$docEntry');
      final response = await http.post(
        Uri.parse(
            'http://91.203.133.224:92/api/WareSmart/v1/PostAuditLoadComplete?AuditId=26'),
        headers: {
          "accept": "/",
